...
auth.onAuthStateChanged(user => {
   ...
   // console.log(reportID);
	 ...
	 db.collection('FinalReport/'+'UserID/' + user.uid ).doc(reportID).get().then(function(doc) {
    ...
    Sdate = new Date(doc.data().Start_Date);
            ...
            comp = cdate.getDate() + '/'+ cmonth+ '/'+ cdate.getFullYear();
                        ...
                        <div class="col-md-12"id="invoice"style="padding-top:30px; ">
                            ...
                            <div class="card" >
                              <div class=" bg-transparent header-elements-inline">
                                    ...
                                    <h6 style="padding: 10px; text-align: center; font-size: 16px;" class="card-title ">LAPORAN AKHIR PENYELIDIKAN DALAMAN URG / GERAN SEPADAN URG INTERNAL RESEARCH / MATCHING GRANT FINAL REPORT                                
                                    </h6>
                                ...
                                <div  style="background-color:rgb(255, 255, 255); padding: .4rem 1rem;">
                                  ...
                                  <h6 style=" font-size: 16px;" class="card-title ">AKUAN KETUA PENYELIDIK / DECLARATION OF THE PRINCIPAL INVESTIGATOR</h6>
                                   ...
                                   <h6 style=" font-size: 13px; padding: .4rem 1rem;" class="card-title ">
                                    ...
                                    <h6 style=" font-size: 13px; padding: .4rem 1rem;" class="card-title ">
                                      Signature & Official Stamp of Principal Investigator : <br><br><br>
