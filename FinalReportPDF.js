  ...
  var title =  sessionStorage.getItem("title").toUpperCase();
  var reference = sessionStorage.getItem("reference").toUpperCase();
  var duration =  sessionStorage.getItem("duration").toUpperCase();
  var dateStart = sessionStorage.getItem("dateStart").toUpperCase();
  var dateEnd =sessionStorage.getItem("dateEnd").toUpperCase();
  var exDate =      sessionStorage.getItem("exDate").toUpperCase();
  var compDate =      sessionStorage.getItem("dateComplete").toUpperCase();
  var DateReport = sessionStorage.getItem("DateReport").toUpperCase();
  var Status =    sessionStorage.getItem("Status").toUpperCase();
  var ReportNumber = sessionStorage.getItem("ReportNumber");
  var PrincipalName = sessionStorage.getItem("PrincipalName").toUpperCase();
  var PrincipalID =      sessionStorage.getItem("PrincipalID").toUpperCase();
  var ProjectMember =  sessionStorage.getItem("ProjectMember").toUpperCase();
  var Recommend =      sessionStorage.getItem("Recommend").toUpperCase();
  var Reason =      sessionStorage.getItem("Reason").toUpperCase();

  var Research =     sessionStorage.getItem("Research").toUpperCase();
  var Deliverables =        sessionStorage.getItem("Deliverables").toUpperCase();
  var RiskManagement =        sessionStorage.getItem("RiskManagement").toUpperCase();              
  var Future =       sessionStorage.getItem("Future").toUpperCase();   

    
    

  var FundingAllocation=  sessionStorage.getItem("FundingAllocation");
  var FundingSpent= sessionStorage.getItem("FundingSpent");
  var PercentSpent=  sessionStorage.getItem("PercentSpent");



  var Funding1Allocation=  sessionStorage.getItem("Funding1Allocation");
  var Funding2Allocation= sessionStorage.getItem("Funding2Allocation");
  var Funding3Allocation= sessionStorage.getItem("Funding3Allocation");
  var Funding4Allocation=sessionStorage.getItem("Funding4Allocation");
  var Funding5Allocation=  sessionStorage.getItem("Funding5Allocation");
  var Funding6Allocation= sessionStorage.getItem("Funding6Allocation");
  var Funding7Allocation=    sessionStorage.getItem("Funding7Allocation");
  var Funding8Allocation=     sessionStorage.getItem("Funding8Allocation");

  var Funding1Spent=     sessionStorage.getItem("Funding1Spent");
  var Funding2Spent=   sessionStorage.getItem("Funding2Spent");
  var Funding3Spent=    sessionStorage.getItem("Funding3Spent");
  var Funding4Spent=   sessionStorage.getItem("Funding4Spent");
  var Funding5Spent= sessionStorage.getItem("Funding5Spent");
  var Funding6Spent=   sessionStorage.getItem("Funding6Spent");
  var Funding7Spent=      sessionStorage.getItem("Funding7Spent");
  var Funding8Spent=    sessionStorage.getItem("Funding8Spent");




  var TotalReceived   =    sessionStorage.getItem("TotalReceived");
  var  TotalReturn  =   sessionStorage.getItem("TotalReturn");
  var  TotalInput  =   sessionStorage.getItem("TotalInput");
  var  TotalInput  =   sessionStorage.getItem("TotalInput");
...
<div class="col-md-12"id="invoice"style="padding-top:30px; ">
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${title}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${reference}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${duration}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${parseFloat(TotalInput).toFixed(2)}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${dateStart + " to "+ dateEnd}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${exDate}</h6>
    ...
    <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
        ...
        <h6 style=" font-size: 13px;" class="card-title ">${compDate}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${Status}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${ReportNumber}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <h6 style=" font-size:13px;" class="card-title ">${PrincipalName}</h6>
        <h6 style=" font-size:13px;" class="card-title ">${PrincipalID}</h6>
    ...
    <div class="card-header bg-transparent  header-elements-inline " >
        ...
        <div style="right: 10px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
            ...
            <h6 style=" font-size: 13px;" class="card-title ">${ProjectMember}</h6>
    ...
    <div class="card-header bg-transparent " >
      ...
      <div >
            ...
            <h6 style=" font-size: 13px;" >${Research} </h6>
    ...
    <div class="card-header bg-transparent " >
      ...
      <div >
            ...
            <h6 style=" font-size: 13px;" >${Deliverables}</h6>
    ...
    <div class="card-header bg-transparent " >
      ...
      <div >
            ...
            <h6 style=" font-size: 13px;" >${RiskManagement}</h6>
     ...
     <div class="card-header bg-transparent " >
      ...
      <div >
            ...
            <h6 style=" font-size: 13px;" >${Future}</h6>
      ...
      <div style="left: 15px; min-height:150px; height: auto; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
          ...
          <div class="mb-4 pull-right">
              ...
              <ul class="list list-unstyled mb-0 text-left">
                  <li><input type="checkbox"  checked  onclick="return false;" onkeydown="e = e || window.event; if(e.keyCode !== 9) return false;"> &nbsp;${Recommend}</br>${Reason}</li>
  ...
  <div class="card">
        ...
        <div  class="card-header bg-transparent  header-elements-inline "  >
          ...
          <div style="right: 10px; " class=" col-md-13 bg-transparent  header-elements-inline " >
            ...
            <table style="  border: 1px solid rgba(0,0,0,.125);" class="table table-lg">
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding1Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding1Spent).toFixed(2)} </td>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding2Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding2Spent).toFixed(2)} </td>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding3Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding3Spent).toFixed(2)} </td>
                  </tr>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding4Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding4Spent).toFixed(2)} </td>
                  </tr>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding5Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding5Spent).toFixed(2)} </td>
                  </tr>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding6Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding6Spent).toFixed(2)} </td>
                  </tr>
                  </table>
                  </div>
                  </div>
        ...
        <div style="right: 10px; " class=" col-md-13 bg-transparent  header-elements-inline " >
          ...
          <table style=" border: 1px solid rgba(0,0,0,.125);" class="table table-lg">
             ...
             <tr>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding7Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding7Spent).toFixed(2)} </td>
                  </tr>
                  ...
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding8Allocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(Funding8Spent).toFixed(2)} </td>
                  </tr>
                  ...
                  <tr style=" width :425px;">
                    ...
                    <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(FundingAllocation).toFixed(2)} </td>
                  <td style="border-left: 1px solid #dee2e6;">RM ${parseFloat(FundingSpent).toFixed(2)} </td>
                  </tr>
                  ...
                  <tr style=" width :425px;"  >
                    ...
                    <td style="border-left: 1px solid #dee2e6;border-right: 1px solid #dee2e6; text-align: center;" colspan="2" >RM ${parseFloat(TotalReceived).toFixed(2)} </td>
                  ...
                  <tr style=" width :425px;">
                    ...
                    <td style="border-left: 1px solid #dee2e6;border-right: 1px solid #dee2e6; text-align: center;" colspan="2" >RM ${parseFloat(TotalReturn).toFixed(2)} </td>
                  ...
                  <tr style=" width :425px;">
                    ...
                    <td style="border-left: 1px solid #dee2e6;border-right: 1px solid #dee2e6; text-align: center;" colspan="2" >${parseFloat(PercentSpent).toFixed(2)} %</td>
          ...
          <h6 style=" font-size: 16px;" class="card-title ">AKUAN KETUA PENYELIDIK / DECLARATION OF THE PRINCIPAL INVESTIGATOR</h6>
           ...
           <h6 style=" font-size: 13px; padding: .4rem 1rem;" class="card-title ">
            ...
            <h6 style=" font-size: 13px; padding: .4rem 1rem;" class="card-title ">
              ...
              <div><br> <img style="height: 100px;" src=" ${(sign)}"></div><br>
              <div> <img style="height: 100px;" src=" ${(stamp)}"></div>
              </h6>
            <h6 style=" font-size: 13px; padding: .4rem 1rem;"class="card-title " >
              Tarikh	: ${(DateReport)}
    ...
    <div  class=" card-headerr  bg-transparent " style="padding: 15px;"  >
      ...
      <h6 style=" font-size: 13px; text-decoration-line: underline;padding: 10px;" > <h6 style=" font-size: 13px;" >
      ...
      <h6 style=" font-size: 13px;" >
        ...
        <h6 style=" font-size: 13px;" >
          ...
          <h6 style=" font-size: 15px;" >
            ...
            <br><br>
            <div> <img style="height: 100px;" src=""></div><br>
            <div> <img style="height: 100px;" src=" "></div>
