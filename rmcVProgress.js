...
var SignLink =";"
        ...
        /* function encodeImageFileURL(){
            ...
            if (fileSelect.length > 0 ){
                ...
                fileReader.readAsDataURL(fileSelect.toString('base64'));
...
//console.log(userID)
	 ...
	 db.collection('ReportProgress/'+'UserID/' + userID ).doc(reportID).get().then(function(doc) {
       ...
       // encodeImageFileURL();
                        ...
                        const html = `
                            ...
                            <div class="col-md-12"id="invoice" style="padding-top:30px;">
                                ...
                                <div class="card-header bg-transparent  header-elements-inline " >
                                    ...
                                    <div style="left: 15px; border-left: 1px solid rgba(0,0,0,.125);" class=" col-md-8 bg-transparent  header-elements-inline " >
                                        ...
                                        <h6 style=" font-size: 13px;" class="card-title ">${parseInt(doc.data().Total).toFixed(2)}</h6>
                                    ...
                                    <div class=" col-md-8 bg-transparent  header-elements-inline   " >
                                        ...
                                        <table style=" width :625px; border: 1px solid rgba(0,0,0,.125);" class="table table-lg">
                                            <tr  style=" width :425px;" >
                                                ...
                                                <td style=" width :125px; left: 15px; border-left: 1px solid #dee2e6;"> RM ${parseInt(doc.data().Aproved_Grant).toFixed(2)}</td>
                                            ...
                                            <td style=" width :125px; border-left: 1px solid #dee2e6;">RM ${parseInt(doc.data().Received_Grant).toFixed(2)}</td>
                                            ...
                                            <td style=" width :125px; border-left: 1px solid #dee2e6;">RM ${parseInt(doc.data().Total_Grant).toFixed(2)} </td>
                                            </tr>
                                            <tr style=" width :425px;">
                                                <td>
                                                <h6 style="font-size: 13px; text-align: right; left: 15px;" class="mb-0">Baki dalam simpanan / Balance in hand</h6> 
                                            </td>
                                            <td style="width :125px; border-left: 1px solid #dee2e6;">RM ${parseInt(doc.data().Balance).toFixed(2)}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="card-header bg-transparent ">
                                    ...
                                    <h6 style=" font-size: 13px;" >${doc.data().Synopsis}
                                        ...
                                        <br>  <br>  <br>
                                        <div> <img id = "ImageFile" style="height: 100px;" src=" ${(doc.data().SignURL)}"></div><br>
                                ...
                                <h6 style="border: none;" class="card-title ">NOTA RMC / NOTE BY RMC  </h6><br>
                                    <h6 style=" font-size: 13px; text-decoration-line: underline;padding: 10px;" >${(doc.data().RMC_Note)}
                            ...
                            document.getElementById("download")
                                ...
                                .addEventListener("click", () => {
                                    window.location.href = "rmcApproval.html"
